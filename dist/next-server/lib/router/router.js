...
class Router {
     ...
     */
    // Static Data Cache
    constructor(_pathname, _query, _as, {initialProps, pageLoader, App, wrapApp, Component, err, subscription, isFallback}) {
        this.route = void 0;
    ...
    update(route, mod) {
        ...
        const newData = Object.assign({}, data, {Component, __N_SSG: mod.__N_SSG, __N_SSP: mod.__N_SSP});
    ...
    async change(method, url, as, options) {
        ...
        const query = (0, _searchParamsToUrlQuery.searchParamsToUrlQuery)(searchParams);
        ...
        if ((0, _isDynamic.isDynamicRoute)(route)) {
            const {pathname: asPathname} = (0, _parseRelativeUrl.parseRelativeUrl)(cleanedAs);
    ...
    async handleRouteInfoError(err, pathname, query, as, loadErrorFail) {
        ...
        try {
            ...
            const routeInfo = {Component, err, error: err};
            try {
